...
FLUTTER_PLUGIN_EXPORT GType dynamic_app_icon_changer_plugin_get_type();

FLUTTER_PLUGIN_EXPORT void dynamic_app_icon_changer_plugin_register_with_registrar(
